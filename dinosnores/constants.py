...
HERBIVORE_STATS: dict[HerbivoreType, HerbivoreStats] = {
    HerbivoreType.STEGOSAURUS: HerbivoreStats(
        base_damage=10, soup_production=3, plant_level_required=4
    ),
    HerbivoreType.TRICERATOPS: HerbivoreStats(
        base_damage=50, soup_production=0, plant_level_required=5
    ),
    HerbivoreType.BRONTOSAURUS: HerbivoreStats(
        base_damage=20, soup_production=5, plant_level_required=6
    ),
}

CARNIVORE_STATS: dict[CarnivoreType, CarnivoreStats] = {
    CarnivoreType.PTERODACTYL: CarnivoreStats(
        base_damage=100, herbivore_food=HerbivoreType.STEGOSAURUS
    ),
    CarnivoreType.RAPTOR: CarnivoreStats(
        base_damage=400, herbivore_food=HerbivoreType.BRONTOSAURUS
    ),
}
...
HERBIVORE_NEST_EGG_PROBS: dict[int, list[tuple[HerbivoreType, float]]] = {
    ...
    4: [
        (HerbivoreType.STEGOSAURUS, 0.20),
        (HerbivoreType.TRICERATOPS, 0.50),
        (HerbivoreType.BRONTOSAURUS, 0.30),
    ],
...
VOLCANIC_PATCH_PLANT_PROBS: dict[int, list[tuple[int, float]]] = {
    1: [(1, 1.00)],
    2: [(1, 0.70), (2, 0.30)],
    3: [(2, 1.00)],
    4: [(2, 0.70), (3, 0.30)],
...
CARNIVORE_NEST_EGG_PROBS: dict[int, list[tuple[CarnivoreType, float]]] = {
...
BYE_BYE_PLANET_REDUCTION: list[int] = [
    0,
    120,
    240,
    360,
]  # turns removed from recharge (20/40/60 real-time minutes)
